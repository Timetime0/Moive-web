...
import {
  ...
  GET_LENGTH_DATA_NGUOIDUNG,
  GET_DATA_NGUOIDUNG_THEOTRANG,
  FIND_DATA_NGUOIDUNG_THEOTRANG,
  FIND_DATA_NGUOIDUNG_THEOTRANG_SAGA,
  FIND_DATA_NGUOIDUNG,
  ...
  GET_IN4_CLIENT,
  GET_IN4_CLIENT_SAGA,
} from "../../Types/Admin/quanLyNguoiDungType";
import {
  addDataNguoiDung,
  deleteDataNguoiDung,
  findDataNguoiDung,
  findDataNguoiDungTheoTrang,
  getDataNguoiDung,
  getDataNguoiDungPhanTrang,
  thongTinClient,
  updateDataNguoiDung,
} from "../../../Services/QuanLyNguoiDung/QuanLyNguoiDung";
...
function* findDataNguoiDungTheoTrangApi(action) {
  try {
    let result = yield call(() => {
      return findDataNguoiDungTheoTrang(
        action.tuKhoa,
        action.soTrang,
        action.soPhanTuTrang
      );
    });
