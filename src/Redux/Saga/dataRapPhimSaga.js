...
import {
  DataDanhSachRap,
  DataThongTinCumRapTheoHeThong,
  DataThongTinLichChieuTheoHeThongRap,
  DataThongTinLichChieuTheoPhim,
} from "../../Services/QuanLyRap/QuanLyRap";
import {
  GET_DATA_CUM_THEATER,
  GET_DATA_CUM_THEATER_SAGA,
  GET_DATA_LICHCHIEU_HETHONG,
  GET_DATA_LICHCHIEU_HETHONG_SAGA,
  GET_DATA_LICHCHIEU_MAPHIM,
  GET_DATA_LICHCHIEU_MAPHIM_SAGA,
  GET_INFOR_THEATER,
  GET_INFOR_THEATER_SAGA,
  GET_DATA_LICHCHIEU_MAPHIM_SAGA_FIND,
  GET_DATA_LICHCHIEU_MAPHIM_FIND,
} from "../Types/dataRapPhim";
...
export function* theoDoiActionGetDataThongTinLichChieuTheoHeThong() {
  yield takeLatest(
    GET_DATA_LICHCHIEU_HETHONG_SAGA,
    getDataThongTinLichChieuTheoHeThong
  );
}
...
export function* theoDoiActionGetDataThongTinLichChieuTheoMaPhim() {
  yield takeLatest(
    GET_DATA_LICHCHIEU_MAPHIM_SAGA,
    getDataThongTinLichChieuTheoMaPhim
  );
}
...
export function* theoDoiActionGetDataThongTinLichChieuTheoMaPhimFind() {
  yield takeLatest(
    GET_DATA_LICHCHIEU_MAPHIM_SAGA_FIND,
    getDataThongTinLichChieuTheoMaPhimByFinding
  );
}
...
export function* theoDoiActionGetDataThongTinLichChieuTheoHeThongRap() {
  yield takeLatest(
    GET_DATA_LICHCHIEU_HETHONG_SAGA,
    getDataLichChieuTheoHeThongRap
  );
}
