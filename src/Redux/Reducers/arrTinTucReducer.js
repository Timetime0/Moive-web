const initialState = {
  dienAnh: [
    {
      hinhAnh: "/Assets/img/TinTuc/1.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/2.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/3.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/4.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/1.1.jpg",
      noiDungChinh: "Khai trương rạp xịn giá ngon, chuẩn xì-tai Sài Gòn",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/1.2.png",
      noiDungChinh: "“Bóc tem” tổ hợp giải trí mới toanh của giới Hà Thành",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/1.3.png",
      noiDungChinh:
        "Tiệc Trăng Máu chính thức cán mốc 100 tỷ chỉ sau 2 tuần công chiếu ",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/1.4.jpg",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/5.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/6.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/7.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/hinh.png",
      noiDungChinh:
    ...
    {
      hinhAnh: "/Assets/img/TinTuc/2.1.png",
      noiDungChinh:
        "6 đạo diễn tỉ đô làm nên thành công của những bom tấn đình đám nhất Hollywood",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/2.2.png",
      noiDungChinh: "Gái Già Lắm Chiêu V – Những cuộc đời vương giả",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/2.3.png",
      noiDungChinh:
        "Kaity Nguyễn trở thành mỹ nhân mới của vũ trụ Gái Già Lắm Chiêu",
      noiDungPhu: "",
    },
    {
      hinhAnh: "/Assets/img/TinTuc/2.4.png",
      noiDungChinh:
