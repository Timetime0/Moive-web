...
import { ImgChiTiet, DivBgChiTiet, DivHeader, SpanImgInner, DivPlay, CircleIn, CirclePut, Rate, CircleBar, CircleFill, Slice, Star, H1Phim, SpanContent, DivFrameCarousel, DivFrameInnerCarousel } from '../../StyledComponent/ChiTietPhim/ChiTietPhim'
...
class CaroselChiTietPhim extends Component {
    ...
    render() {
        ...
        return (
            <DivFrameCarousel className="chiTietPhim__carousel" style={{ position: 'relative' }}>
                            ...
                            <div className="col-md-8">
                                <div className="row">
                                    <SpanImgInner className="col-sm-6 col-12">
                                        ...
                                        <StyledPopup trigger={
                                            <DivPlay className="divPlay"><i className="fa fa-play-circle"></i></DivPlay>} modal nested>
                                            {close => (
...
export default connect(mapStateToProps)(CaroselChiTietPhim)