...
import {
  DELETE_NGUOIDUNG_SAGA,
  FIND_DATA_NGUOIDUNG_SAGA,
  GET_DATA_NGUOIDUNG_SAGA,
  GET_DATA_NGUOIDUNG_THEOTRANG_SAGA,
...
import {
  ...
  Li,
  Trang,
} from "../../../StyledComponent/Admin/QuanLyNguoiDung/quanLyNguoiDung";
...
class QuanLyNguoiDung extends Component {
    ...
    return arr?.map((item, index) => {
      return (
        <Li
          key={index}
          name={index + 1}
          onClick={() => this.onClickRender(index + 1, "get")}
          className={this.isActive(index + 1, "get")}
        >
        ...
        <tr key={index}>
          ...
          <td>
            <button
              ...
              onClick={() => this.handleModalWithFix(item)}
              data-toggle="modal"
            ...
            <button
              ...
              onClick={() => this.handleDeleteUser(item.taiKhoan)}
            >
              Xóa
            </button>
          </td>
  ...
  handleOnSubmitTimKiem = (e) => {
    ...
    const newStr = this.state.findHoTen
      .normalize("NFD")
      .replace(/[\u0300-\u036f]/g, "")
      .toLowerCase()
      .trim()
        ...
        <div>
          <div className="container-fluid">
            <div className="row my-1">
              <div className="col-6 text-center">
                <Trang className="btn mx-2 ">Trang {this.state.selected}</Trang>
              </div>
              <ButtonThem
                onClick={() => this.handleModalWithAdd()}
                data-toggle="modal"
                data-target="#exampleModal"
              ...
              <div className=" col-4">
                <form
                  ...
                  onSubmit={this.handleOnSubmitTimKiem}
                >
                  <div className="input-group-prepend">
                    <button
                      onClick={this.renderDataFinding}
                      id="find-user"
                      type="submit"
                  ...
                  <input
                    ...
                    placeholder="Họ Tên hoặc Tài Khoản (double click 'icon')"
                    name="findHoTen"
                    autoComplete="off"
                  />
                </form>
          ...
          <div className="container-fluid">
            <table className="table table-dark">
              ...
              <tbody>{this.renderGiaoDien()}</tbody>
            </table>
          </div>
        </div>
        <div
          ...
          aria-hidden="true"
        >
          <DivModalAd className="modal-dialog" id="myModalNguoiDung">
