...
import { BookingContent, BookingImg,BookingForm,Form, FormInput, Img, MessageErrors } from '../../StyledComponent/Login/DangKyStyled'
        ...
        return (
            <BookingContent className="booking-content">
                ...
                <BookingForm className="booking-form">
                    <Form id="booking-formDk" onSubmit={(event)=>this.handleSubmit(event)}>
                        ...
                        <FormInput className="form-group form-input">
                            <input onChange={this.onChangeValue} type="text" name="email"   required autoComplete='off'/>
                        ...
                        <FormInput className="form-group form-input">
                            <input onChange={this.onChangeValue} type="text" name="sdt"   required autoComplete='off'/>
                        ...
                        <FormInput className="form-group form-input" style={{display:'none'}}>
                            <input onChange={this.onChangeValue} type="text" name="maNhom"  value="gp01" required  autoComplete='off'/>
                        ...
                        <FormInput className="form-group form-input displayNone" style={{display:'none'}}>
                            <input onChange={this.onChangeValue} type="text" name="maLoai"   value="KhachHang" required autoComplete='off'/>
                            <label htmlFor="maLoai" className="form-label">Mã loai người dùng</label>
                        </FormInput>

                        <FormInput className="form-group form-input displayNone" >
                            <input onChange={this.onChangeValue} type="text" name="hoTen"  required autoComplete='off'/>
                            <label htmlFor="hoTen" className="form-label">Họ tên</label>
                            <MessageErrors>{this.state.err.hoTen}</MessageErrors>
                        </FormInput>

                        <div className="form-submit text-center">
                            <input type="submit" value="Đăng ký" className="submit btn btn-success"  name="submit" />
                        </div>
                    </Form>
                </BookingForm>
            </BookingContent>
