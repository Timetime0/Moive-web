...
import {
  ...
  DivModalContent,
  ButtonModalSignUp,
} from "../../StyledComponent/Login/LoginStyled";
    ...
    return (
      <ContainerLogin id="loginIntheHeader">
        <Content>
          <BgImage />
          <DivFrameLogin>
            <h2 style={{ paddingBottom: 80 }}>
              TimeTime Cinemax <br></br> đang chờ bạn <br></br> ^O^{" "}
            </h2>
            <p style={{ paddingBottom: "20px" }}>
              Tài khoản: string <br></br> Mật khẩu: string
            </p>
            ...
            <LinkImgLogin>
              <DivImgLogin
                ...
                data-target="#login"
                inputBgColor="#3f64b7"
                inputBgColorHover="#fff"
              >
                <i
                  style={{ padding: "0 25px", lineHeight: "25px" }}
            ...
            <LinkImgLogin>
              ...
              >
                ...
                ></i>
                <PLogin inputBgColor="#000" className="login__p">
                  Login with Google
                </PLogin>
              </DivImgLogin>
            </LinkImgLogin>
            ...
            >
              {(close) => (
                <DivModal className="modal">
                  <ButtonModalSignUp className="close" onClick={close}>
                    &times;
                  </ButtonModalSignUp>
