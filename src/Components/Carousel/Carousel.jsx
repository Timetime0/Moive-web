...
import {
  ...
  ButtonIframe,
  DivRight,
} from "../../StyledComponent/Carousel/DivPosition.js";
...
import {
  ...
  LiCarosel,
  DivFrameCarousel,
} from "../../StyledComponent/Carousel/Link.js";
                  ...
                  <div className="col-md-4 carousel__left">
                    <DivCarouselCaption className="carousel__img-inner carousel-caption">
                      ...
                      <DivPositionHeader>
                        ...
                        <div className="m-5">
                          <LinkPlay
                            onClick={() => this.rendelModel(movie.trailer)}
                            data-toggle="modal"
                        ...
                        <div className="carousel__footer">
                          <DivRowFooter className="row">
                            ...
                            <DivRightAim className="col-6 divRightAim">
                              <SpanRight as="a" className="text-right">
                                15k view
                              </SpanRight>
                            </DivRightAim>
                          </DivRowFooter>
      ...
      <DivFrameCarousel>
        ...
        >
          ...
          <div className="carousel-inner">
            ...
            <div className="carousel-item">{this.renderCarousel()[1]}</div>
            <div className="carousel-item">{this.renderCarousel()[2]}</div>
          </div>
          <LinkClick
