...
import {
  ...
  Logo,
  DivRapChieuPhim,
} from "../../StyledComponent/RapChieuPhim/RapChieuPhim";
import hinhAnh from "../../Assets/img/rapChieuPhim/lich-chieu-1.jpg";
import {
  DivChiTietRap,
  DivScreen,
  ImgLogoCumRap,
} from "../../StyledComponent/RapChieuPhim/CumRap";
          ...
          <div>
            <DivFrameLogoRap>
              <ImgLogoRap
                ...
                onMouseEnter={(event) => {
                  this.props.dispatch({
                    type: GET_DATA_CUM_THEATER_SAGA,
            ...
            <DivNameRap>{rap.tenHeThongRap}</DivNameRap>
          </div>
        </div>
      );
    });
  ...
  renderScreen = (chiTietRap) => {
    if (chiTietRap) {
      return chiTietRap.map((item, index) => {
        return (
          <DivScreen className="col-md-2 col-3" key={index}>
            {item.tenRap} - {item.maRap}
          </DivScreen>
        );
      });
    }
  ...
  render() {
    ...
    return (
      <DivRapChieuPhim className="rapPhim">
        ...
        <DivChiTietRap
          className="container pt-sm-3 text-center"
          id="chiTietRap"
        >
                ...
                <div className="row">
                  ...
                  <div className="col-sm-10">
                    ...
                    <div className="row justify-content-center">
                      {" "}
                      {this.renderScreen(chiTiet.danhSachRap)}
                    </div>
                  </div>
                </div>
              </>
