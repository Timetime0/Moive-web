...
import {
  ...
  NavHashLinkT,
  NavLinkT,
} from "../../StyledComponent/Header/Header";
...
export class Header extends Component {
      ...
      return (
        <div className="btn-user ml-auto pr-1">
          <BtnHeader
            ...
            className="px-3 btn btn-outline-success mr-2"
          >
            {" "}
            Hi: {this.state.client.taiKhoan}
          </BtnHeader>
          <BtnHeader
            onClick={this.hanleLogOut}
  ...
  render() {
    return (
      <Nav
        className={
          this.state.show_fixNav
            ? "navbar navbar-expand-md navbar-dark py-0"
            : "navbar navbar-expand-md navbar-dark py-0 nav-faded"
        }
      >
        <NavLink className="navbar-brand m-0" to="/" id="timetime">
          {" "}
          <ImgLogo src="/Assets/img/logo/logo-removebg.png" alt="true" />
        </NavLink>
